...
export { default as JNFForm } from './JNFForm'
export { default as CreateDriveForm } from './CreateDriveForm'
export { default as TprDrives } from './TprDrives'
export { default as StudentData } from './StudentData'
export { default as StudentResume } from './StudentResume'
export { default as TPODashboard } from './TPODashboard'
export { default as CompanyWiseDetails } from './CompanyWiseDetails'
export { default as NextPlacementEligibilityPercentage } from './NextPlacementEligibilityPercentage'
